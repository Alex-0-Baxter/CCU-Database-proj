...
INSERT INTO dbo.Burgers VALUES
	...
	,('Bacon Burger','','9.20','39','50','690','Hand-formed patties hot off the grill, layered with strips of crispy apple-wood smoked bacon and placed on a soft, toasted sesame seed bun. Choose as many toppings as you want.')
	,('Bacon Cheeseburger','10.99','1060','40','62','1310','Fresh patties hot off the grill with American-style cheese and crispy apple-wood smoked bacon. Placed on a soft, toasted sesame seed bun. Choose as many toppings as you want.')
	,('Little Hamburger','6.69','540','39','26','380','Fresh, hand-formed patty hot off the grill. Add as many toppings as you want.')
	,('Little Cheeseburger','7.89','610','39.5','32','690','Fresh, hand-formed patty hot off the grill with American-style cheese. Add as many toppings as you want.')
...
DROP Table IF exists FoodParts
GO

CREATE TABLE FoodParts (
  ID INT IDENTITY PRIMARY KEY,
  fk_MenuItem INT FOREIGN KEY REFERENCES menuItems2(menuItemID2) ON DELETE CASCADE,
  fk_Ingredient INT FOREIGN KEY REFERENCES Ingredients(ID) ON DELETE CASCADE,
  Quantity INT CHECK(Quantity >=0),
  [CreateDateTime] datetime DEFAULT GETDATE(),
  [ModifiedDateTime] datetime DEFAULT GETDATE()
);
